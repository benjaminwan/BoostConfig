...
fun getMarginItemDecoration(context: Context, left: Int, top: Int, right: Int, bottom: Int) =
...
fun RecyclerView.setMarginItemDecoration(left: Int, top: Int, right: Int, bottom: Int) {
    addItemDecoration(getMarginItemDecoration(context, left, top, right, bottom))
}
 ...
 * @param  bottom 底边距
 */
fun RecyclerView.setMarginItemDecorationAndDrawBottomSeparator(
